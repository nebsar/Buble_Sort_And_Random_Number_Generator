...
${OBJECTDIR}/CPP_11_Uniform_Unbiased_Rand_Num_Gen.o: CPP_11_Uniform_Unbiased_Rand_Num_Gen.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPP_11_Uniform_Unbiased_Rand_Num_Gen.o CPP_11_Uniform_Unbiased_Rand_Num_Gen.cpp

${OBJECTDIR}/Random_Number_Generator.o: Random_Number_Generator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Random_Number_Generator.o Random_Number_Generator.cpp
